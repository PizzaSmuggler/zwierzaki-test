            ...
            <div class="row">
                                ...
                                <div class="col-6 col-md-6 col-lg-4 mb-3">
                                    <div class="card h-100 border-0">
                                        ...
                                        <div class="card-body text-center">
                                            <h4 class="card-title">
                                                <a href="product.html" class=" font-weight-bold text-dark text-uppercase small"> {{$advert->name}}</a>
                                            </h4>
                                            <h5 class="card-price small">
                                                <i>
                                                     DO ZROBIENIA MIASTO</i>
                                            </h5>
                                        </div>
                                    </div>
                                </div>
                ...
                <form class="col-md-4 order-md-1 col-lg-3 sidebar-filter">
                    ...
                    <div class="mt-2 mb-2 pl-2">
                        <input type="text" class="custom-control-input form-control" id="name">
                    </div>
...
@endsection
@section('javascript')
    @vite(['resources/js/filterWelcome.js'])
@endsection
