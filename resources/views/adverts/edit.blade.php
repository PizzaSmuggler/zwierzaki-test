                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('adverts.update',$advert->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="age" type="number" max="30" class="form-control @error('age') is-invalid @enderror" name="age" value="{{ $advert->age }}" required autocomplete="name" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="weight" type="number" max="500" class="form-control @error('weight') is-invalid @enderror" name="weight" value="{{ $advert->weight }}" required>
